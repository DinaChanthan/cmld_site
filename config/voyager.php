...
return [
    ...
    */
    ...
    'additional_css' => [
        'css/voyager/extracss.css',
    ],

    'additional_js' => [
        'js/voyager/extrajs.js',
    ],

    'googlemaps' => [
         'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyALs_IVe8MbehimtbG7mX49d42uuIQSVNU'),
         'center' => [
             'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '11.580241'),
             'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '104.922364'),
         ],
